<template>
	<transition enter-active-class="ani fade-in" leave-active-class="ani fade-out">
		<div class="play-song-list-container" v-show="isShow">
			<transition enter-active-class="ani fade-in" leave-active-class="ani fade-out">
				<div
					class="mask"
...
<script>
	...
	export default {
		components: { BetterScrollItem, MyScrollItem },
		computed: {
			...mapState({
